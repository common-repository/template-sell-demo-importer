...
function templatesell_demo_importer_import_files() {
    ...
    array(
        ...
        'preview_url'                => 'https://www.templatesell.net/intimate/',
    ),

    array(
        'import_file_name'=> __('Classic Demo','templatesell-demo-importer'),
        'categories'      =>  array( 'Classic' ),
        'local_import_file'=> plugin_dir_path( __FILE__ ) . 'dummy-data-files/classic/classic.xml',
        'local_import_widget_file'     =>  plugin_dir_path( __FILE__ ) . 'dummy-data-files/classic/classic.wie',
        'local_import_customizer_file' =>  plugin_dir_path( __FILE__ ) . 'dummy-data-files/classic/classic.dat',
        'import_preview_image_url'   => plugin_dir_url( __FILE__ ) . 'dummy-data-files/assets/main.jpg',
        'import_notice'              => __( 'Import the demo and check the options inside Appearance > Customize.', 'templatesell-demo-importer' ),
        'preview_url'                => 'https://www.templatesell.net/intimate-classic/',
    ),
);
