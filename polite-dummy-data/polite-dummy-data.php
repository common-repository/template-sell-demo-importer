...
function templatesell_demo_importer_import_files() {
    ...
    array(
        ...
        'preview_url'                => 'https://www.templatesell.net/polite/',
    ),

    array(
        'import_file_name'=> __('Grid Demo','templatesell-demo-importer'),
        'categories'      =>  array( 'Grid' ),
        'local_import_file'=> plugin_dir_path( __FILE__ ) . 'dummy-data-files/grid/grid.xml',
        'local_import_widget_file'     =>  plugin_dir_path( __FILE__ ) . 'dummy-data-files/grid/grid.wie',
        'local_import_customizer_file' =>  plugin_dir_path( __FILE__ ) . 'dummy-data-files/grid/grid.dat',
        'import_preview_image_url'   => plugin_dir_url( __FILE__ ) . 'dummy-data-files/assets/grid.jpg',
        'import_notice'              => __( 'Import the demo and check the options inside Appearance > Customize.', 'templatesell-demo-importer' ),
        'preview_url'                => 'https://www.templatesell.net/polite-grid/',
    ),
);
